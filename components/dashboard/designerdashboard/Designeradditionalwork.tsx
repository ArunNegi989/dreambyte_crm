...
import { AdditionalWork } from "@/types/designer/Designer";
import styles from "@/public/assets/styles/dashboard/designerdashboard/Designeradditionalwork.module.css";

interface DesignerAdditionalWorkProps {
  items: AdditionalWork[];
  onStatusChange: (id: string, status: "pending" | "completed") => void;
  onAddItem: (title: string, description: string) => void;
}

export default function DesignerAdditionalWork({
  items,
  onStatusChange,
  onAddItem,
}: DesignerAdditionalWorkProps) {
        ...
        <div className={styles.formCard}>
          <div className={styles.field}>
            ...
            <input
              ...
              placeholder="e.g. Urgent banner for internal meeting…"
              value={title}
