...
import { AdditionalWork, WorkStatus } from "@/types/photography/Photo";
import styles from "@/public/assets/styles/dashboard/photographer-dashboard/Additionalwork.module.css";

interface AdditionalWorkBoardProps {
  items: AdditionalWork[];
  onStatusChange: (id: string, status: WorkStatus) => void;
  onAddItem: (title: string, description: string) => void;
}

export default function AdditionalWorkBoard({
  items,
  onStatusChange,
  onAddItem,
}: AdditionalWorkBoardProps) {
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.sub}>Extra tasks outside scheduled shoots &amp; edits</p>
        </div>
        ...
        <div className={styles.formCard}>
          <div className={styles.field}>
            ...
            <input
              ...
              placeholder="e.g. Cleaned lenses, backed up footage…"
              value={title}
